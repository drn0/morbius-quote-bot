...
"Somewhere you could study, learn, hone your k*ll.",
...
"His development of artificial bl*od has saved more lives than penicillin.",
...
"These are the only mammals on Earth that have evolved to feed exclusively on bl*od.",
...
"All the bodies that you're looking at are nearly drained of their bl*od.",
"So, what hunts at night and drinks human bl*od?",
...
"[BEEPS]",
"[RECORDER BEEPS]",
"As a result of my procedure, I have an overpowering urge to consume… bl*od.",
"Human bl*od.",
...
"And all of this… on artificial bl*od.",
"[♪♪♪]",
...
"Artificial bl*od keeps me stable for six hours.",
"But that window… is growing shorter.",
"Artificial bl*od won't work forever.",
"One question remains: What if…?",
"What if artificial bl*od becomes ineffective?",
...
"What?",
"“bl*od.”",
"You want the bl*od in the freezer? Wait.",
"[GROANS]",
...
"I can't.",
"I need this. I… I've done things, Milo. I k*ll people.",
"W-we… We can make that go away.",
"The ones on the boat, they're thugs, g*n for hire.",
...
"We also noticed that their bl*od was… What do you call it?",
...
"MAN 3: Looks like all the bl*od was drained from her body.",
"[PEOPLE MURMURING]",
"Any contusions?",
"Not that I can see.",
...
"Your artificial bl*od actually saved my arm in Afghanistan, sir.",
...
"DISPATCHER [ECHOES OVER RADIO]: All units, the 120 block, Horizon Labs, female body drained of bl*od, initiate lock down.",
...
"At this rate, artificial bl*od will stop working in a matter of days.",
"8:13 p.m.",
...
"They're charging me with m*rder.",
...
"This place is for t*rrorists and drugs lords and God knows who.",
"Michael, we need to get you out of here.",
"In whatever way possible.",
"Maybe this is where I belong.",
"If I'm in here, then nobody else dies.",
"Listen to me.",
"You are not capable of k*ll that woman.",
"[POUNDING ON DOOR]",
...
"Artificial bl*od will keep us stable until I do.",
...
"I didn't k*ll Nurse Sutton or the police.",
...
"Thankfully, artificial bl*od keeps me stable.",
...
"[SCREAMS]",
"The metacarpals.",
"Shit. Let's get the f*ck out of here!",
...
"Here was I thinking you were a complete assh*le.",
...
"Something wakes up inside of me, something… primal. And it just, uh… And it wants to hunt. And wants to k*ll.",
"[BREATHING HEAVILY]",
"I'm sorry.",
"[CAT MEOWS]",
"[COUGHS]",
...
"[♪♪♪]",
"[TRAIN RATTLING]",
"Did you know the average male body has 12 pints of bl*od?",
...
"Breaking news on the Lower East Side where three people have been k*ll.",
"Authorities have confirmed the discovery of three new bodies outside a bar popular with Wall Street traders.",
"And like the v*ctim before them, they were completely drained of their bl*od, earning the k*ll the moniker “Vampire m*rder.”",
"The prime suspect, renowned scientist Dr. Michael Morbius, remains at large.",
"What have you got yourself into?",
"However, another source inside the department has told us that CCTV footage of the m*rder suggests the k*ll could be a copycat.",
"Residents are being urged to stay home after sundown until the k*ll, or k*ll, are brought to justice.",
"NICHOLAS: Milo?",
"[PILLS RATTLE]",
...
"“Against the many.”",
"[GROWLS]",
"Tell Michael, you tell him I'm going to k*ll as many as I want.",
"[GROWLING]",
"[ROARS]",
...
"By tomorrow I'll be forced to consume human bl*od.",
...
"[♪♪♪]",
"[♪♪♪]",
"[MATT SMITH'S POPPING PUSSING SQUELCHES LOUDLY]",
"die"]
let xie = 0
...
client.on('messageCreate', (message) => {
  xie += 1
  if (xie === 500) {
    message.channel.send(morbiArray[Math.floor(Math.random() * morbiArray.length)])
  }

  if (message.content === 'morbie, speak to me') {
    message.reply(morbiArray[Math.floor(Math.random() * morbiArray.length)])
  }

  if (message.content === 'morbie, kys') {
    message.reply('no, you kys lmfao')
  }
})
